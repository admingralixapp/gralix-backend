...
const MOBILITY_POSE_LIBRARY: Record<string, PoseSet> = {
  ...
  "Negative Pull-Ups": [
    { // START
      head: { cx: 51, cy: 19, r: 6 },
      lines: [
        [[50.5,28.5],[50,47],[50,41.5]],
        [[50.5,28.5],[38,33.5],[34,20.5],[32.5,18.5]],
        [[50.5,28.5],[63,32.5],[70,20.5],[71.5,18.5]],
        [[50,41.5],[45.5,60],[45,73.5]],
        [[50,41.5],[55,60],[55.5,73.5]],
      ],
    },
    { // MID
      head: { cx: 50.5, cy: 38.5, r: 4.75 },
      lines: [
        [[50.5,48.5],[50.5,60.5],[50.5,63.5]],
        [[50.5,48.5],[42,35],[37.5,23],[37,20.5]],
        [[50.5,48.5],[59.5,35],[63.5,22.5],[63.5,20]],
        [[50.5,63.5],[46,81],[45,89]],
        [[50.5,63.5],[55,81],[55.5,88.5]],
      ],
    },
    { // END
      head: { cx: 51, cy: 19, r: 6 },
