...
const MOBILITY_POSE_LIBRARY: Record<string, PoseSet> = {
  ...
  "Low Lunge Hip Flexor": [
    { // START
      head: { cx: 67, cy: 50, r: 7 },
      lines: [
        [[59.5,51],[50,66.5]],
        [[59.5,51],[53,76],[52.5,95],[52.5,99.5]],
        [[59.5,51],[58.5,59.5],[57,72.5],[57,75.5]],
        [[50,66.5],[44.5,77.5],[32.5,79.5]],
        [[50,66.5],[62.5,68],[63,89.5]],
      ],
    },
    { // MID
      head: { cx: 64.375, cy: 46, r: 7 },
      lines: [
        [[57,48.875],[50,74.75]],
        [[57,48.875],[53.5,75.625],[52.5,93.5],[52.5,98.25]],
        [[57,48.875],[48.5,49.25],[46.875,51.375],[47.25,51.875]],
        [[50,74.75],[41.75,68.875],[44.25,62.5]],
        [[50,74.75],[59.5,69.5],[63.5,90]],
      ],
    },
    { // END
      head: { cx: 64, cy: 46, r: 7 },
      lines: [
        [[56,48.5],[50.5,74.5]],
        [[56,48.5],[53,75.5],[52.5,93.5],[52.5,98]],
        [[56,48.5],[48.5,48.5],[47.5,50],[48.5,51]],
        [[50.5,74.5],[42,70.5],[44,62.5]],
        [[50.5,74.5],[59.5,69],[63.5,90]],
      ],
    },
  ],
