...
const MOBILITY_POSE_LIBRARY: Record<string, PoseSet> = {
  ...
  "Archer Push-Up": [
    { // START
      ...
      lines: [
        [[40.5,55.5],[43,44]],
        [[41.5,50.5],[34,55],[33.5,49],[31.5,60],[27.5,61]],
    ...
    { // MID
      ...
      lines: [
        [[48,53.5],[48,44]],
        [[50.5,38.5],[36.5,52.5],[34,61.5],[29.5,62]],
        [[50.5,38.5],[60.5,52.5],[63.5,61.5],[67,62]],
    ...
    { // END
      ...
      lines: [
        [[51.5,55.5],[49,44]],
        [[50.5,50.5],[58,55],[58.5,49],[60.5,60],[64.5,61]],
        [[50.5,50.5],[33,56],[25,61],[22.5,62]],
        [[49,44],[43,38],[41,32.5],[39.5,28]],
        [[49,44],[48,37],[46.5,30.5],[45,27.5]],
      ],
    },
  ],
  ...
  "Diamond Push-Up": [
    { // START
      ...
      lines: [
        [[65,47],[41,55.5]],
        [[65,47],[63.5,62.5],[64.5,73.5],[67,77]],
        [[65,47],[70,62],[70.5,73],[69,77.5]],
        [[41,55.5],[21.5,68],[11.5,73.5]],
        [[41,55.5],[28.5,68],[17,75]],
      ],
    },
    { // MID
      head: { cx: 77.5, cy: 55, r: 7.5 },
      lines: [
        [[67,56.5],[41.5,60.5]],
        [[67,56.5],[59.5,71],[63,74.5],[66.5,77]],
        [[67,56.5],[74,67],[71,73.5],[68,77]],
        [[41.5,60.5],[26,65],[11.5,70]],
        [[41.5,60.5],[22.5,71.5],[14.5,74]],
      ],
    },
    { // END
      head: { cx: 78, cy: 45, r: 7.5 },
  ...
  "Pike Push-Up": [
    { // START
      head: { cx: 73.5, cy: 56.5, r: 7.5 },
      lines: [
        [[69,46.5],[47,38.5]],
        [[69,46.5],[59.5,69],[57.5,80.5],[62,82]],
        [[69,46.5],[70,56.5],[70,61.5],[74,62]],
        [[47,38.5],[38,61.5],[30,75],[34,78.5]],
        [[47,38.5],[45,60],[39.5,73.5],[43,75.5]],
      ],
    },
    { // MID
      ...
      lines: [
        [[65.5,61],[49,40]],
        [[65.5,61],[59,68.5],[57,80],[61,80.5]],
        [[65.5,61],[69.5,48],[70.5,59.5],[73.5,60]],
        [[49,40],[38,61.5],[31,74.5],[35,77.5]],
        [[49,40],[45.5,59.5],[39,72.5],[43.5,75.5]],
      ],
    },
    { // END
      head: { cx: 73.5, cy: 56.5, r: 7.5 },
  ...
  "Wall Push-Up": [
    { // START
      ...
      lines: [
        [[44.5,30],[41,55]],
        [[44.5,30],[62,37],[69.5,39],[72.5,40]],
        [[44.5,30],[65.5,31.5],[74.5,33.5],[76.5,34.5]],
        [[41,55],[37.5,69.5],[33,82.5],[38,83]],
        [[41,55],[43,70.5],[40,85],[45,85.5]],
      ],
    },
    { // MID
      head: { cx: 68.5, cy: 31.5, r: 7.5 },
      lines: [
        [[63,39],[50.5,55]],
        [[63,39],[58,32],[69.5,30.5],[78.5,34.5],[79,34.5]],
        [[63,39],[64.5,42.5],[71,45],[77,42],[79.5,41]],
        [[50.5,55],[44,70.5],[34,82.5],[38,84]],
        [[50.5,55],[49.5,72.5],[42,84.5],[46.5,85]],
      ],
    },
    { // END
      head: { cx: 46.5, cy: 19, r: 7.5 },
  ...
  "Elevated Pike Push-Up": [
    { // START
      head: { cx: 66.5, cy: 62.5, r: 7.5 },
      lines: [
        [[62,52],[47,38.5]],
        [[62,52],[56,69],[54,78],[57.5,78.5]],
        [[62,52],[67,61.5],[67,67],[69.5,67.5]],
        [[47,38.5],[33,53.5],[25.5,61],[29.5,62]],
        [[47,38.5],[39,57],[35,61],[37.5,62]],
      ],
    },
    { // MID
      head: { cx: 65.5, cy: 70, r: 7.5 },
      lines: [
        [[61,57.5],[47,38.5]],
        [[61,57.5],[49,72.5],[54,78],[57.5,78.5]],
        [[61,57.5],[71.5,60],[67,67],[69.5,67.5]],
        [[47,38.5],[33,53.5],[25.5,61],[29.5,62]],
        [[47,38.5],[39,57],[35,61],[37.5,62]],
      ],
    },
  ...
  "Pseudo Planche Push-Up": [
    ...
    { // MID
      head: { cx: 78, cy: 50, r: 7.5 },
      lines: [
        [[68.5,44.5],[47,38.5]],
        [[68.5,44.5],[48.5,44],[47.5,61.5],[44.5,63.5]],
        [[68.5,44.5],[60,39],[56.5,59.5],[60,57.5]],
        [[47,38.5],[31,47.5],[17,49]],
        [[47,38.5],[34.5,45],[20.5,47]],
      ],
    },
  ...
  "Incline Push-Up": [
    ...
    { // MID
      ...
      lines: [
        ...
        [[62.5,45],[72.5,40],[69.5,60],[71.5,61]],
        [[49,56],[37.5,68],[25.5,79],[29,79.5]],
        [[49,56],[43.5,69.5],[33,80],[36,81]],
      ],
    },
    { // END
      head: { cx: 56.5, cy: 28.5, r: 7.5 },
