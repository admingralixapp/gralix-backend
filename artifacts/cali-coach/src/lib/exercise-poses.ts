...
const MOBILITY_POSE_LIBRARY: Record<string, PoseSet> = {
  ...
  "Wrist Extension Stretch": [
    { // START
      ...
      lines: [
        [[50,22],[46,49.5]],
        [[51,31],[65,33],[73,33],[73.5,37.5]],
        [[51,31],[63,40],[73,44],[78,41]],
        [[46,49.5],[47.5,73.5],[43.5,85],[48,85.5]],
        [[46,49.5],[55,74],[57,85.5],[60.5,85]],
      ],
    },
    { // MID
      head: { cx: 50, cy: 16, r: 6 },
      lines: [
        [[50,22],[45.5,49.5]],
        [[51,31],[65,33],[77.5,34],[80.5,38]],
        [[51,31],[63,40],[73,44],[73,40]],
        [[45.5,49.5],[47.5,73.5],[43.5,85],[48,85.5]],
        [[45.5,49.5],[55,74],[57,85.5],[60.5,85]],
      ],
    },
    { // END
      head: { cx: 50, cy: 16, r: 6 },
  ...
  "Planche Leans": [
    { // START
      head: { cx: 91.75, cy: 59.25, r: 7.5 },
      lines: [
        [[78.25,56.375],[53.75,61.25]],
        [[78.25,56.375],[64.125,81.25],[61.875,107.75],[64.75,111.25]],
        [[78.25,56.375],[74.5,69.75],[73,90.5],[76,93.375]],
        [[53.75,61.25],[37.75,70.375],[24,71.875]],
        [[53.75,61.25],[41.25,67.875],[27.5,70.125]],
      ],
    },
    { // MID
      head: { cx: 91, cy: 86.125, r: 7.5 },
      lines: [
        [[78.75,74.75],[54,72.75]],
        [[78.75,74.75],[60.625,84.25],[61.5,107.875],[64,111.875]],
        [[78.75,74.75],[74.375,71.5],[74.5,90],[76.75,93.5]],
        [[54,72.75],[37.75,75.875],[25,71.625]],
        [[54,72.75],[41.875,72.125],[28.875,69]],
      ],
    },
    { // END
      head: { cx: 92, cy: 52, r: 7.5 },
      lines: [
        [[78.5,52],[54,59]],
        [[78.5,52],[66.5,80.5],[62,107.5],[65,110.5]],
        [[78.5,52],[74.5,69.5],[73,90],[76,93]],
        [[54,59],[37,69.5],[24,72]],
        [[54,59],[41,67.5],[27.5,70.5]],
      ],
    },
  ],
...
export const EXERCISE_WORLD_OBJECTS: Record<string, EnvAnchor[]> = {
  "Wrist Extension Stretch": [
    { type: "floor", x1: 4, y1: 90, x2: 96, y2: 90 },
  ],
// <<<WORLD_OBJECTS_END>>>
};
