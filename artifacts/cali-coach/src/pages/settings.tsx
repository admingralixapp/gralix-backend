        ...
        <section ref={membershipRef}>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-bold" style={{ color: "#e9d5ff" }}>{t("settings.caliCoachPro")}</div>
          ...
          >
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-black text-base text-white">{t("settings.sorrySeeYouGo")}</span>
              </div>
              <button
                onClick={() => setCancelStep(null)}
            ...
            <div className="flex gap-2.5 pt-1">
              ...
              >
                {cancelSubscription.isPending ? t("settings.cancellingLabel") : t("settings.cancelMembership")}
              </button>
            </div>
          </div>
        </>,
